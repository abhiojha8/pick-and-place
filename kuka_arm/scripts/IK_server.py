...
def handle_calculate_IK(req):
    ...
    if len(req.poses) < 1:
        ...
        # Create symbols and joint variables
        ...
        # Create individual transformation matrix
    ...
    for x in xrange(0, len(req.poses)):
        ...
        # Compensate for rotation discrepancy with Gazebo links
        ...
        # Calculate the joint angles using Gemoetric IK method
        theta1 = atan2(wy, wx)
